...
function insertData(data) {
  ...
  // Initialize primaryToken with existing IDs
...
function onDelete(target) {
  ...
  // Remove the ID from the primaryToken array
  var indexToDelete = primaryToken.indexOf(idToDelete);
  if (indexToDelete !== -1) {
    primaryToken.splice(indexToDelete, 1);
  }
